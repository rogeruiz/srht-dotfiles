...
nnoremap <C-i> <cmd>lua require('telescope.builtin').resume()<cr>
nnoremap <leader>bt <cmd>lua require('telescope.builtin').live_grep({hidden=true})<cr>
nnoremap <leader>bb <cmd>lua require('telescope.builtin').buffers()<cr>
nnoremap <leader>ba <cmd>lua require('telescope.builtin').help_tags()<cr>
